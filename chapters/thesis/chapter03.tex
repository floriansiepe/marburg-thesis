...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.5\textwidth]{gfx/thesis/setup}
...
\begin{figure}[bth]
  ...
  \subfloat[Asia personas duo.]{
     ...
     \includegraphics[width=.45\linewidth]{gfx/thesis/qq-plot_gaus_vs_160}
   } \quad
   \subfloat[Pan ma signo.] {
     \label{fig:chapter03:subfloat:grafik2}
     \includegraphics[width=.45\linewidth]{gfx/thesis/pdf_gaus_vs_uni_vs_10_40_160}
   } \\
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[b]{5 cm}
    \includegraphics[width=\linewidth]{gfx/thesis/qq-plot_gaus_vs_160}
    \caption{Minipage-Grafik Nummero uno}
    \label{fig:chapter03:minipage:grafik1}
  \end{minipage}
  \begin{minipage}[b]{5 cm}
    \includegraphics[width=\linewidth]{gfx/thesis/pdf_gaus_vs_uni_vs_10_40_160}
