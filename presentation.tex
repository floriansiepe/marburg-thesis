...
\usepackage{lmodern}
\usetheme{default}
\definecolor{marburgBlue}{HTML}{23396e}
\usecolortheme[named=marburgBlue]{structure}

\begin{document}
    \author{Author}
    \title{Title}
    \subtitle{Subtitle}
    %\logo{\includegraphics[width=.2\paperwidth]{gfx/logo_blue}}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{5cm}
                \begin{overprint}
                    \includegraphics[width=5cm]<2>{gfx/logo_blue}
                    \includegraphics[width=5cm]<4>{gfx/logo_blue}
                    \includegraphics[width=5cm]<6>{gfx/logo_blue}
                \end{overprint}
            \end{column}
        \end{columns}
    \end{frame}
